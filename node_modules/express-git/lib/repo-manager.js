...
(function() {
  var EventEmitter, Promise, RepoManager, _, _path, git, using,
  ...
  RepoManager = (function(superClass) {
    ...
    function RepoManager(root, options) {
      this.root = root;
      if (options == null) {
        options = {};
      }
      this.options = _.defaults({}, options, {
        ...
        auto_init: true,
        init_options: {},
        disposable: function(a) {
          return a;
        }
      });
      this.disposable = this.options.disposable;
    }

    RepoManager.prototype.parse = function(path) {
      var match, name;
      name = path.replace(/\.git$/, "");
      match = name.match(this.options.pattern);
    ...
    RepoManager.prototype.openOrInit = function(path, options) {
      return this.open(path).then((function(_this) {
        return function(repo) {
          if (repo != null) {
            return [repo, false];
          } else if (_this.options.auto_init) {
