...
(function() {
  var INIT_FLAG, INIT_MODE, Promise, ZEROID, _path, asrev, assign, g, ref1, trim,
    slice = [].slice;
  ...
  g.Commit.prototype._oidMethod = "id";

  g.Blob.prototype._oidMethod = "id";

  g.Note.prototype._oidMethod = "id";

  g.OdbObject.prototype._oidMethod = "id";

  g.Object.prototype._oidMethod = "id";

  g.Tag.prototype._oidMethod = "id";

  g.Tree.prototype._oidMethod = "id";

  g.TreeEntry.prototype._oidProperty = "oid";

  g.Reference.prototype._oidMethod = "target";

  g.IndexEntry.prototype._oidProperty = "id";

  g.RebaseOperation.prototype._oidProperty = "id";

  g.DiffFile.prototype._oidProperty = "id";
  ...
  g.Oid.fromAnything = function(item) {
    if (item instanceof g.Oid) {
      ...
      return item[item._oidMethod]();
    } else if (item._oidProperty) {
      return item[item._oidProperty];
    } else if (item != null) {
      return g.Oid.fromString("" + item);
    } else {
      return g.Oid.ZERO;
    }
  };
